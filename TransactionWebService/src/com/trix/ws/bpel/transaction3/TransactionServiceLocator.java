...
public class TransactionServiceLocator extends org.apache.axis.client.Service implements com.trix.ws.bpel.transaction3.TransactionService {
    ...
    public com.trix.ws.bpel.transaction3.TransactionPortType gettransaction() throws javax.xml.rpc.ServiceException {
    ...
    public com.trix.ws.bpel.transaction3.TransactionPortType gettransaction(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.trix.ws.bpel.transaction3.TransactionSoapBindingStub _stub = new com.trix.ws.bpel.transaction3.TransactionSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.trix.ws.bpel.transaction3.TransactionPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.trix.ws.bpel.transaction3.TransactionSoapBindingStub _stub = new com.trix.ws.bpel.transaction3.TransactionSoapBindingStub(new java.net.URL(transaction_address), this);
                _stub.setPortName(gettransactionWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://trix.com/ws/bpel/transaction3", "transactionService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://trix.com/ws/bpel/transaction3", "transaction"));
        }
